    ...
    public partial class CreateInitial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_plan_features", x => new { x.plan_id, x.feature_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_plan_pricings_plans_plan_id",
                        column: x => x.plan_id,
                        principalTable: "plans",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_plan_pricings_regions_region_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_feature_usages_features_feature_id",
                        column: x => x.feature_id,
                        principalTable: "features",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_feature_usages_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    plan_pricing_id = table.Column<Guid>(type: "uuid", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    deleted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    parent_task_item_id = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    task_items_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_task_item_tags", x => new { x.tags_id, x.task_items_id });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_task_item_tags_task_items_task_items_id",
                        column: x => x.task_items_id,
                        principalTable: "task_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_feature_usages_feature_id",
                table: "feature_usages",
                column: "feature_id");

            migrationBuilder.CreateIndex(
                name: "ix_feature_usages_user_id_feature_id_usage_date",
                table: "feature_usages",
                columns: new[] { "user_id", "feature_id", "usage_date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_plan_pricings_plan_id",
                table: "plan_pricings",
                column: "plan_id");

            migrationBuilder.CreateIndex(
                name: "ix_plan_pricings_region_id",
                table: "plan_pricings",
                column: "region_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_task_item_tags_task_items_id",
                table: "task_item_tags",
                column: "task_items_id");
